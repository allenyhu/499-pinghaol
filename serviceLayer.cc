...
int ServiceLayerImpliment::follow (std::string user1, std::string user2, KeyValueMap &store) {
...
int ServiceLayerImpliment::chirp(std::string user1, std::string chirp,std::string parent, KeyValueMap &store)
    {
        getID(store);
        Chirp newChirp;
        ...
        std::string id = to_string(counter);
...
std::vector<string> ServiceLayerImpliment::read(std::string chirp_id, KeyValueMap &store)
{
    std::vector<string> v;
...
std::vector<std::string> ServiceLayerImpliment::monitor(std::string user1, KeyValueMap &store) {
    std::vector<string> v;
    std::string username = user1;
    ...
    std::vector<int> list;
    std::cout << "testing : " << follow_user.username_size() << endl;
...
std::vector<std::string> ServiceLayerImpliment::stream(std::string user, std::string hashtag) {
